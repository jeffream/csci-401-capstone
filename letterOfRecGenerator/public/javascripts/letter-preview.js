...
function onLoad() {
    $.ajax({
        url: appRoot+'/letter-preview/form',
        data: {id},
        type: 'GET',
...
function saveEditModal() {
    ...
    $.ajax({
        url: appRoot+'/letter-preview/save',
        data: {
            id: id,
            letter: letterHTML
        },
...
function downloadLetterOLD() {
    ...
    $.ajax({
        url: appRoot+'/letter-preview/drive',
        data: {
            id:id,
            letter: letterHTML,
            date: date
...
function saveLetter() {
    ...
    $.ajax({
        url: appRoot+'/letter-preview/templateUpload',
        data: {
            id:id,
            letter: letterHTML,
            formID: idt,
...
function downloadLetter() {
    event.preventDefault();
    $.ajax({
        url: appRoot+'/letter-preview/downloads',
        type: 'GET',
        success: function(d) {
            console.log("letter download success");
            window.open(appRoot+'/letter-preview/downloads?foo=bar&xxx=yyy');
        },
        error: function() {
...
function test(){
    $.ajax({
        url: appRoot+'/letter-preview/test',
        data: {
            id: id
        },
        type: 'POST',
...
function parseEmailLetter(body) {
    ...
    $.ajax({
        url: appRoot+'/email-letter-preview/emailForm',
        data: {id},
        type: 'GET',
        success: function (data) {
            form = data.form;
...
function addEmailHistory() {
    ...
    $.ajax({
        url: appRoot+'/letter-preview/addEmailHistory',
        data: {
            id: id,
            Email: Email
        },
        ...
        success: function (data) {
            ...
            window.location.href = appRoot+'/history'
        },
        error: function () {

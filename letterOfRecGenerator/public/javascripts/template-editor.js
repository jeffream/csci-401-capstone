...
function saveTemplate() {
    ...
    if (id) {
        $.ajax({
            url: 'http://128.125.100.147:3000/template-editor/update',
            data: {
                id: id,
                template: template
            },
            ...
            success: function (data) {
                ...
                window.location.href = 'http://128.125.100.147:3000/template-dashboard'
            },
            error: function (err){
        ...
        $.ajax({
            url: 'http://128.125.100.147:3000/template-editor/create',
